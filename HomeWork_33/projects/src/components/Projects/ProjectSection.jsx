...
import { loadProjects } from '../../reducer/ProjectReducer';
...
export default function ProjectSection() {
    ...
    let [time, setTime] = useState(`${new Intl.DateTimeFormat("en-US", { month: "long" }).format(new Date())}, ${new Date().getDate()}`)
    ...
    useEffect(() => dispatch(loadProjects(allProjectsArray)), []);
    return (
        <div className="projects-section">
            ...
            <ProjectBoxes classesView={classesView}/>
        </div>
    )
}